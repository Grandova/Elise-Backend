...
impl OutboundDialer {
    ...
    async fn dial_socks5(
        ...
        if let (Some(u), Some(p)) = (username, password) {
            ...
            // SOCKS5 Auth negotiation: 0x02 (User/Pass) and 0x00 (No auth)
            ...
            // Handshake: [VER 0x05] [NMETHODS 1] [METHODS 0x00 (NO AUTH)]
        ...
        // Request: [VER 0x05] [CMD 0x01 (CONNECT)] [RSV 0x00] [ATYP 0x03 (DOMAIN)] [LEN] [DOMAIN] [PORT]
