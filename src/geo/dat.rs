//! High-performance binary parser and matcher for geoip.dat and geosite.dat
//! Compliant with standard V2Ray/Xray/Sing-box protobuf rules dat format.
...
// ============================================================================
// Zero-Copy Protobuf Wire Reader
// ============================================================================
...
// ============================================================================
// GeoIP Engine (Interval Binary Search)
// ============================================================================

#[derive(Debug, Clone, Default)]
pub struct CountryIpList {
    // (start_ip, end_ip) inclusive ranges, sorted and merged
...
pub struct GeoIpFile {
    data: Vec<u8>,
    // Country code -> slice offset & length in data
...
// ============================================================================
// GeoSite Engine (Domain Trie & Exact Match)
// ============================================================================
    ...
    pub fn load_group(&self, tag: &str) -> Option<SiteGroupList> {
        ...
        while !reader.is_eof() {
            ...
            if tag == 2 && wire == 2 {
                ...
                if !dval.is_empty() {
                    match dtype {
                        0 => group.keywords.push(dval), // Plain / Keyword
                        1 => {
                            // Regex
                        ...
                        2 => group.domain_suffixes.push(dval), // Domain suffix
                        3 => {
                            // Full exact
