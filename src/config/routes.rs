...
impl RoutesConfig {
    ...
    pub fn parse_content(content: &str) -> Self {
        // First try standard TOML routes file with [[routes]] and [[routes.Outs]]
        ...
        // Fallback: structured RoutesConfig
    ...
    /// Import panel runtime routes and outbounds (from Xboard / XiaoV2Board)
